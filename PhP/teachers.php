...
<div class="side-bar">
   ...
   <nav class="navbar">
      <a href="view_course_teacher.php"><i class="fas fa-book"></i><span>View Course (Teacher)</span></a>
      <a href="add_attendance.php"><i class="fas fa-user-clock"></i><span>Add Attendance</span></a>
      <a href="advising.html"><i class="fas fa-comments"></i><span>Advising</span></a>
      <a href="view_profile.html"><i class="fas fa-user-circle"></i><span>View Profile</span></a>
      <a href="view_grade_history.html"><i class="fas fa-history"></i><span>View Grade History</span></a>
      <a href="tnotification.php"><i class="fas fa-bell"></i><span>Notification Page</span></a>
      <a href="service.html"><i class="fas fa-handshake"></i><span>Service</span></a>
   </nav>
</div>
