...
<section class="home-grid" style="background: linear-gradient(to bottom, #33ccff 0%, #ff99cc 100%)">
   ...
   <div class="box-container">
      <div class="box">
         <h2 class="title"><a href="faculty_evaluation.php?course=CSE482">CSE482 - Advanced Database Management System</a></h2>
      ...
      <div class="box">
         <h1 class="title"><a href="faculty_evaluation.php?course=CSE428L">CSE428L - Software Engineering Lab</a></h1>
      ...
      <div class="box">
         <h1 class="title"><a href="faculty_evaluation.php?course=MAT250">MAT250 - Linear Algebra</a></h1>
      ...
      <div class="box">
         <h1 class="title"><a href="faculty_evaluation.php?course=ENG110">ENG110 - English Composition</a></h1>
         <h2 class="description">This course focuses on developing writing skills, including grammar, syntax, and composition.</h2>
      </div>
      <div class="box">
         <h1 class="title"><a href="faculty_evaluation.php?course=CHEM210">CHEM210 - Organic Chemistry</a></h1>
      ...
      <div class="box">
         <h1 class="title"><a href="faculty_evaluation.php?course=BIO450">BIO450 - Molecular Biology</a></h1>
      ...
      <div class="box">
         <h1 class="title"><a href="faculty_evaluation.php?course=PHY301">PHY301 - Quantum Mechanics</a></h1>
      ...
      <div class="box">
         <h1 class="title"><a href="faculty_evaluation.php?course=MAT202">MAT202 - Calculus II</a></h1>
      ...
      <div class="box">
         <h1 class="title"><a href="faculty_evaluation.php?course=EEE305">EEE305 - Digital Signal Processing</a></h1>
